  ...
  return (
    <div className="bg-black w-full h-full text-white flex flex-col md:flex-row items-center p-8">
      <div className="flex-1 flex flex-col mb-8 md:mb-0 p-6 rounded-lg shadow-lg">
        ...
        <p className="text-lg mb-2 text-gray-300">
          <strong>Product:</strong> Aerosol Optical Thickness at 1610nm, Deep Blue Algorithm
        </p>
        ...
        <div className="mb-2 mt-0">
          <label htmlFor="dateInput" className="block text-lg mb-2 mt-0">
            Select a date to view the PACE's OCI image (within the last 214 days):
          </label>
          <input
            type="date"
            id="dateInput"
        ...
        <div className="text-center mb-4 ">
          {date && (
            <p className="text-lg text-gray-400">
              Selected Date: <span className="font-bold">{new Date(date).toLocaleDateString()}</span>
            </p>
          )}
        </div>
