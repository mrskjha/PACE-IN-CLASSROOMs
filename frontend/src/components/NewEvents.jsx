  ...
  return (
    <div className="relative w-full min-h-screen p-8 bg-gray-100">
        ...
        <div className="flex flex-wrap gap-8 justify-center">
          <div className="flex flex-col md:flex-row w-full md:w-1/2 bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="p-4 flex flex-col ">
              ...
              <p className="mt-4">
                Recent data highlights an extensive Phytoplankton bloom in the
                Atlantic Ocean, offering insights into marine ecosystem health.
              </p>
            </div>
            <img
          ...
          <div className="flex flex-col md:flex-row w-full md:w-1/2 bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="p-4 flex flex-col ">
              ...
              <p className="mt-4">
                The PACE satellite captures crucial data over the Pacific Ocean,
                aiding climate researchers in understanding ocean dynamics.
              </p>
            </div>
            <img
              className="w-full md:w-1/3 h-48 object-cover"
        ...
        <div className="flex flex-wrap gap-8 justify-center">
          <div className="flex flex-col md:flex-row w-full md:w-1/2 bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="p-4 flex flex-col ">
              ...
              <p className="mt-4">
                PACE's observations reveal significant changes in ocean color,
                indicating shifts in phytoplankton populations and health.
              </p>
            </div>
            <img
          ...
          <div className="flex flex-col md:flex-row w-full md:w-1/2 bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="p-4 flex flex-col ">
              ...
              <p className="mt-4">
                Scientists gather to analyze PACE data, discussing new findings
                and potential impacts on climate prediction models.
              </p>
            </div>
            <img
              className="w-full md:w-1/3 h-48 object-cover"
      ...
      <div className="absolute left-1/2 -translate-x-1/2 ">
        <h1 className="text-5xl font-bold text-indigo-500  mt-20 bg-red-00 ml-[65px] ">
          Join A Course Today!
        </h1><div>
        <p className="mt-5 font-semibold  bg-slate-60 mr-9">
          Unlock your potential with our expert-led courses designed to boost
