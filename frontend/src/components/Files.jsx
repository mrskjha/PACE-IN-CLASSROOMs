...
const Files = () => {
    ...
    return (
        <div className="bg-gray-800 absolute mt-0 top-60 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white p-5 rounded shadow-lg flex flex-col items-center"> {/* Centering the box */}
